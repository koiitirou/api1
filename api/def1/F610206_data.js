  ...
  res.status(200).json(
{
  "def": {
    "2020": {
      ...
      "last_pro": null,
      "title": "超過実労働時間数（女）",
      "title_full": "超過実労働時間数（女）",
      "title_link": "超過実労働時間数（女）",
      "title_txt": "超過実労働時間数（女）",
      "unit2": "時間",
      "additional1": "平均との差",
      "additionalUnit1": "時間",
      "footer1": "平均 6 時間",
      ...
      "time_min1": "2020",
      "time_max1": "2020",
      "rank123_pre": ["岡山県", "宮城県", "東京都", "福井県", "山口県", "宮崎県"],
      "rank123_val": [8, 7, 7, 4, 4, 4],
      "rank123_img": ["okayama_kensho.png", "miyagi_kensho.png", "tokyo_symbol.png", "fukui_kensho.png", "yamaguchi_kensho.png", "miyazaki_kensho.png"]
    }
  },
  "table": {
    "2020": [
  ...
  "line": {
    "disable": ["平均", "全国", "神奈川", "滋賀", "愛媛", "茨城", "栃木", "群馬", "埼玉", "千葉", "山梨", "岐阜", "静岡", "三重", "大阪", "兵庫", "奈良", "島根", "香川", "高知", "佐賀", "長崎", "北海道", "青森", "岩手", "山形", "福島", "富山", "石川", "長野", "愛知", "京都", "和歌山", "鳥取", "広島", "徳島", "福岡", "熊本", "大分", "鹿児島", "沖縄", "秋田", "新潟", "福井", "山口", "宮崎"],
    "color": {
      "平均": "#ECC6E7",
      "全国": "#E9CA8D",
      "北海道": "#CF4368",
