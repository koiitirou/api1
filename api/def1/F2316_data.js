  ...
  res.status(200).json(
{
  "def": {
    "2005": {
      ...
      "last_pro": null,
      "title": "就業者数（林業）（‐2005）",
      "title_full": "就業者数（林業）（‐2005）",
      "title_link": "就業者数（林業）（‐2005）",
      "title_txt": "就業者数（林業）（‐2005）",
      "unit2": "人",
      "additional1": "割合",
      "additionalUnit1": "%",
      ...
      "rank123_val": [7036, 2508, 2311, 209, 154, 100],
  ...
  "line": {
    "disable": ["平均", "全国", "高知", "秋田", "福島", "熊本", "青森", "長野", "大分", "岐阜", "鹿児島", "愛媛", "奈良", "三重", "静岡", "和歌山", "岡山", "群馬", "山梨", "山形", "京都", "宮城", "広島", "島根", "栃木", "石川", "徳島", "茨城", "福岡", "山口", "愛知", "兵庫", "新潟", "鳥取", "滋賀", "福井", "千葉", "東京", "長崎", "埼玉", "佐賀", "神奈川", "富山", "大阪", "沖縄", "香川"],
    "color": {
      "平均": "#ECC6E7",
      "全国": "#E9CA8D",
      "北海道": "#CF4368",
