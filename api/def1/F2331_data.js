  ...
  res.status(200).json(
{
  "def": {
    "2005": {
      ...
      "tab_jp": "観測値",
      "cat01_code": "F2331",
      "cat01_jp": "F2331_就業者数（サービス業（他に分類されない））（‐2005）",
      "area_code": "13000",
      "area_jp": "東京都",
      ...
      "last_dif": null,
      "last_pro": null,
      "title": "就業者数（サービス業（他に分類されない））（‐2005）",
      "title_full": "就業者数（サービス業（他に分類されない））（‐2005）",
      "title_link": "就業者数（サービス業（他に分類されない））（‐2005）",
      "title_txt": "就業者数（サービス業（他に分類されない））（‐2005）",
      "unit2": "人",
      "additional1": "割合",
      "additionalUnit1": "%",
      ...
      "rank123_val": [1115012, 746337, 580290, 42898, 41986, 36102],
  ...
  "line": {
    "disable": ["平均", "全国", "埼玉", "愛知", "千葉", "北海道", "兵庫", "福岡", "静岡", "茨城", "広島", "京都", "宮城", "新潟", "栃木", "岐阜", "群馬", "福島", "長野", "三重", "岡山", "熊本", "滋賀", "鹿児島", "奈良", "沖縄", "山口", "長崎", "青森", "愛媛", "石川", "岩手", "大分", "富山", "山形", "宮崎", "秋田", "香川", "和歌山", "山梨", "福井", "佐賀", "島根", "徳島", "高知", "鳥取"],
    "color": {
      "平均": "#ECC6E7",
      "全国": "#E9CA8D",
      "北海道": "#CF4368",
