  ...
  res.status(200).json(
{
  "def": {
    "2005": {
      ...
      "tab_jp": "観測値",
      "cat01_code": "F280122",
      "cat01_jp": "F280122_従業地による就業者数（情報通信業）（‐2005）",
      "area_code": "13000",
      "area_jp": "東京都",
      ...
      "last_dif": null,
      "last_pro": null,
      "title": "従業地による就業者数（情報通信業）（‐2005）",
      "title_full": "従業地による就業者数（情報通信業）（‐2005）",
      "title_link": "従業地による就業者数（情報通信業）（‐2005）",
      "title_txt": "従業地による就業者数（情報通信業）（‐2005）",
      "unit2": "人",
      "additional1": "割合",
      "additionalUnit1": "%",
      ...
      "rank123_val": [707114, 139906, 129161, 3289, 3126, 2843],
  ...
  "line": {
    "disable": ["平均", "全国", "愛知", "福岡", "北海道", "千葉", "埼玉", "兵庫", "静岡", "広島", "宮城", "京都", "茨城", "長野", "新潟", "岡山", "群馬", "沖縄", "石川", "栃木", "熊本", "福島", "愛媛", "岐阜", "鹿児島", "富山", "岩手", "香川", "三重", "山口", "青森", "長崎", "大分", "山梨", "秋田", "宮崎", "山形", "滋賀", "福井", "和歌山", "奈良", "徳島", "高知", "島根", "佐賀", "鳥取"],
    "color": {
      "平均": "#ECC6E7",
      "全国": "#E9CA8D",
      "北海道": "#CF4368",
