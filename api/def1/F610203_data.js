  ...
  res.status(200).json(
{
  "def": {
    "2020": {
      ...
      "last_pro": null,
      "title": "所定内実労働時間数（男）",
      "title_full": "所定内実労働時間数（男）",
      "title_link": "所定内実労働時間数（男）",
      "title_txt": "所定内実労働時間数（男）",
      "unit2": "時間",
      "additional1": "平均との差",
      "additionalUnit1": "時間",
      "footer1": "平均 167 時間",
      ...
      "time_min1": "2020",
      "time_max1": "2020",
      "rank123_pre": ["愛媛県", "鹿児島県", "沖縄県", "東京都", "愛知県", "滋賀県"],
      "rank123_val": [170, 170, 170, 165, 165, 165],
      "rank123_img": ["ehime_kenki.png", "kagoshima_symbol.png", "okinawa_kensho.png", "tokyo_symbol.png", "aichi_kensho.png", "shiga_kensho.png"]
    }
  },
  "table": {
    "2020": [
  ...
  "line": {
    "disable": ["平均", "全国", "北海道", "佐賀", "熊本", "大分", "岩手", "宮城", "秋田", "山形", "埼玉", "新潟", "石川", "岐阜", "和歌山", "鳥取", "香川", "高知", "長崎", "宮崎", "青森", "福島", "群馬", "千葉", "山梨", "三重", "京都", "大阪", "奈良", "広島", "山口", "福岡", "茨城", "神奈川", "富山", "福井", "長野", "静岡", "兵庫", "島根", "岡山", "徳島", "栃木", "東京", "愛知", "滋賀"],
    "color": {
      "平均": "#ECC6E7",
      "全国": "#E9CA8D",
      "北海道": "#CF4368",
