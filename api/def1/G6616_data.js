  ...
  res.status(200).json(
{
  "def": {
    "2001": {
      ...
      "last_dif": null,
      "last_pro": null,
      "title": "国内旅行行動者率（15歳以上）",
      "title_full": "国内旅行行動者率（15歳以上）",
      "title_link": "国内旅行行動者率（15歳以上）",
      "title_txt": "国内旅行行動者率（15歳以上）",
      "unit2": "%",
      "additional1": "平均との差",
      "additionalUnit1": "%",
      "footer1": "平均 62 %",
      ...
      "rank123_val": [74.9, 74.7, 74.6, 52.5, 46.4, 39.5],
  ...
  "line": {
    "disable": ["平均", "全国", "千葉", "京都", "奈良", "愛知", "大阪", "兵庫", "滋賀", "岐阜", "広島", "石川", "長野", "富山", "福岡", "山梨", "宮城", "群馬", "福井", "静岡", "北海道", "茨城", "栃木", "三重", "新潟", "岡山", "大分", "山形", "福島", "熊本", "宮崎", "島根", "香川", "愛媛", "秋田", "山口", "佐賀", "鳥取", "和歌山", "長崎", "徳島", "鹿児島", "高知", "岩手", "青森", "沖縄"],
    "color": {
      "平均": "#ECC6E7",
      "全国": "#E9CA8D",
      "北海道": "#CF4368",
