  ...
  res.status(200).json(
{
  "def": {
    "2005": {
      ...
      "tab_jp": "観測値",
      "cat01_code": "F280130",
      "cat01_jp": "F280130_従業地による就業者数（複合サービス事業）（‐2005）",
      "area_code": "13000",
      "area_jp": "東京都",
      ...
      "last_dif": null,
      "last_pro": null,
      "title": "従業地による就業者数（複合サービス事業）（‐2005）",
      "title_full": "従業地による就業者数（複合サービス事業）（‐2005）",
      "title_link": "従業地による就業者数（複合サービス事業）（‐2005）",
      "title_txt": "従業地による就業者数（複合サービス事業）（‐2005）",
      "unit2": "人",
      "additional1": "割合",
      "additionalUnit1": "%",
      ...
      "rank123_val": [52302, 40775, 30617, 5537, 5460, 5123],
  ...
  "line": {
    "disable": ["平均", "全国", "大阪", "神奈川", "兵庫", "埼玉", "千葉", "福岡", "静岡", "長野", "新潟", "広島", "宮城", "鹿児島", "熊本", "福島", "茨城", "岐阜", "岩手", "三重", "愛媛", "岡山", "京都", "栃木", "群馬", "山口", "長崎", "山形", "青森", "秋田", "宮崎", "島根", "大分", "石川", "富山", "滋賀", "和歌山", "高知", "佐賀", "香川", "福井", "沖縄", "奈良", "山梨", "徳島", "鳥取"],
    "color": {
      "平均": "#ECC6E7",
      "全国": "#E9CA8D",
      "北海道": "#CF4368",
