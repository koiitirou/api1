  ...
  res.status(200).json(
{
  "def": {
    "2018": {
      ...
      "additional1": "割合",
      "additionalUnit1": "%",
      "footer1": "平均 20 所<br>全国 953 所",
      "sum1": "全国では953所で、平均は20所です。",
      "metainfo1": "",
      "rank_id": "1",
      "time_list1": [
        {
  ...
  "line": {
    "disable": ["平均", "全国", "鹿児島", "熊本", "東京", "長崎", "愛知", "広島", "大阪", "宮崎", "長野", "静岡", "島根", "岡山", "愛媛", "千葉", "岐阜", "山口", "三重", "徳島", "大分", "埼玉", "神奈川", "岩手", "群馬", "新潟", "秋田", "京都", "福島", "茨城", "和歌山", "山形", "栃木", "奈良", "佐賀", "香川", "高知", "青森", "山梨", "宮城", "石川", "福井", "滋賀", "沖縄", "富山", "鳥取"],
    "color": {
      "平均": "#ECC6E7",
      "全国": "#E9CA8D",
      "北海道": "#CF4368",
