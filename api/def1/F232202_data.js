  ...
  res.status(200).json(
{
  "def": {
    "2005": {
      ...
      "tab_jp": "観測値",
      "cat01_code": "F232202",
      "cat01_jp": "F232202_就業者数（情報通信業）（女）（‐2005）",
      "area_code": "13000",
      "area_jp": "東京都",
      ...
      "last_dif": null,
      "last_pro": null,
      "title": "就業者数（情報通信業）（女）（‐2005）",
      "title_full": "就業者数（情報通信業）（女）（‐2005）",
      "title_link": "就業者数（情報通信業）（女）（‐2005）",
      "title_txt": "就業者数（情報通信業）（女）（‐2005）",
      "unit2": "人",
      "additional1": "割合",
      "additionalUnit1": "%",
      "footer1": "平均 9,075 人<br>全国 426,533 人",
      "sum1": "全国では426,533人で、平均は9,075人です。",
      "metainfo1": null,
      "rank_id": "1",
      "time_list1": [
        {
      ...
      "rank123_val": [112614, 52899, 30210, 1234, 969, 841],
  ...
  "line": {
    "disable": ["平均", "全国", "千葉", "大阪", "愛知", "福岡", "兵庫", "北海道", "静岡", "広島", "京都", "茨城", "宮城", "長野", "沖縄", "新潟", "岡山", "群馬", "熊本", "岐阜", "石川", "栃木", "福島", "奈良", "三重", "愛媛", "富山", "鹿児島", "山口", "長崎", "香川", "岩手", "滋賀", "大分", "山梨", "青森", "宮崎", "福井", "和歌山", "山形", "秋田", "徳島", "佐賀", "高知", "島根", "鳥取"],
    "color": {
      "平均": "#ECC6E7",
      "全国": "#E9CA8D",
      "北海道": "#CF4368",
