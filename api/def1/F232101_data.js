  ...
  res.status(200).json(
{
  "def": {
    "2005": {
      ...
      "tab_jp": "観測値",
      "cat01_code": "F232101",
      "cat01_jp": "F232101_就業者数（電気・ガス・熱供給・水道業）（男）（‐2005）",
      "area_code": "13000",
      "area_jp": "東京都",
      ...
      "last_dif": null,
      "last_pro": null,
      "title": "就業者数（電気・ガス・熱供給・水道業）（男）（‐2005）",
      "title_full": "就業者数（電気・ガス・熱供給・水道業）（男）（‐2005）",
      "title_link": "就業者数（電気・ガス・熱供給・水道業）（男）（‐2005）",
      "title_txt": "就業者数（電気・ガス・熱供給・水道業）（男）（‐2005）",
      "unit2": "人",
      "additional1": "割合",
      "additionalUnit1": "%",
      "footer1": "平均 5,218 人<br>全国 245,232 人",
      "sum1": "全国では245,232人で、平均は5,218人です。",
      "metainfo1": null,
      "rank_id": "1",
      "time_list1": [
        {
      ...
      "rank123_val": [15822, 15375, 14834, 1652, 1218, 1203],
  ...
  "line": {
    "disable": ["平均", "全国", "愛知", "千葉", "北海道", "埼玉", "兵庫", "福岡", "広島", "静岡", "新潟", "福島", "茨城", "宮城", "京都", "長野", "三重", "岡山", "岐阜", "福井", "富山", "奈良", "山口", "群馬", "栃木", "鹿児島", "長崎", "和歌山", "愛媛", "沖縄", "熊本", "香川", "滋賀", "岩手", "青森", "秋田", "大分", "石川", "山形", "佐賀", "島根", "山梨", "宮崎", "徳島", "高知", "鳥取"],
    "color": {
      "平均": "#ECC6E7",
      "全国": "#E9CA8D",
      "北海道": "#CF4368",
